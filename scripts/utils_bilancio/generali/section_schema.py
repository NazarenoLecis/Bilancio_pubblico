...
SECTION_SCHEMA = [
    ...
    },
    {
        ...
        "legacy_keys": [
            "peer",
            "peer_series",
            "peer_tax_pressure_series",
            "peer_public_spending_series",
            "peer_social_spending_series",
    ...
    },
    {
        ...
        "description": "Rendiconti OpenBDAP/FET e flussi SIOPE con entrate, spese, saldi, titoli, missioni, codici gestionali e normalizzazioni territoriali.",
        "primary_sources": ["RGS OpenBDAP/FET", "SIOPE", "Eurostat popolazione regionale", "ISTAT/SISTAN superfici"],
        "legacy_keys": ["regional_budgets", "siope_flussi"],
