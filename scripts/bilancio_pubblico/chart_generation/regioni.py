from bilancio_pubblico.regional_budgets import SOURCE_OPENBDAP_REGIONI
from bilancio_pubblico.utils import BLACK, CHART_DIR, NAVY, ORANGE, PAPER, create_post, format_mld, save_chart
...
def plot_regional_balances_by_region(frame):
    ...
    for index, row in enumerate(latest.itertuples(index=False)):
        ...
        ax.text(x_position, index, _format_signed_mld(row.mld), ha=ha, va="center", fontsize=11.5, fontweight="bold")
